    ...
    <div class="col-md-10 col-md-offset-2">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <?php
                ...
                // if(Yii::$app->user->can('admin_category')){
                //     $items=['label'=>'<span class="glyphicon glyphicon-tasks"></span> Category','url'=>['/category/index']];
                // }

                // if(Yii::$app->user->can('admin_post')){
                //     $items=['label'=>'<span class="glyphicon glyphicon-user"></span> User','url'=>['/user/index']];
                // }
                ...
                $items=[
                    ['label'=>'<span class="glyphicon glyphicon-pencil"></span> Post','url'=>['/post/index']],
                    ['label'=>'<span class="glyphicon glyphicon-comment"></span> Comment','url'=>['/comment/index']],
                    ['label'=>'<span class="glyphicon glyphicon-tasks"></span> Category','url'=>['/category/index']],
